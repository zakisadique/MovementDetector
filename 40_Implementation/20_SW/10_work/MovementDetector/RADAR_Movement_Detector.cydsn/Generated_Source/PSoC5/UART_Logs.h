...
#define UART_Logs_RX_INTERRUPT_ENABLED           (0u)
#define UART_Logs_TX_INTERRUPT_ENABLED           (0u)
...
#define UART_Logs_TX_BUFFER_SIZE                 (4u)
#define UART_Logs_RX_BUFFER_SIZE                 (4u)
...
#define UART_Logs_INIT_TX_INTERRUPTS_MASK \
                                  (uint8)((1 << UART_Logs_TX_STS_COMPLETE_SHIFT) \
                                        | (0 << UART_Logs_TX_STS_FIFO_EMPTY_SHIFT) \
