...
*/
     ...
     *  @{
     */
        #define ADC_In_INTR_NONE      (uint16)(0x0000u)
        #define ADC_In_INTR_RISING    (uint16)(0x0001u)
        #define ADC_In_INTR_FALLING   (uint16)(0x0002u)
        #define ADC_In_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define ADC_In_INTR_MASK      (0x01u) 
#endif /* (ADC_In__INTSTAT) */
...
/* SIO registers */
#if defined(ADC_In__SIO_CFG)
    #define ADC_In_SIO_HYST_EN        (* (reg8 *) ADC_In__SIO_HYST_EN)
    #define ADC_In_SIO_REG_HIFREQ     (* (reg8 *) ADC_In__SIO_REG_HIFREQ)
    #define ADC_In_SIO_CFG            (* (reg8 *) ADC_In__SIO_CFG)
    #define ADC_In_SIO_DIFF           (* (reg8 *) ADC_In__SIO_DIFF)
...
/* Interrupt Registers */
	...
	#define ADC_In_0_INTTYPE_REG 		(* (reg8 *) ADC_In__0__INTTYPE)
#endif /* (ADC_In__INTSTAT) */
