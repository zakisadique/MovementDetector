...
# Date: Mon, 08 Jul 2024 16:08:29 GMT
#set_units -time ns
...
create_clock -name {Clock_DMA_FFT_UART(routed)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/dclk_3}]]
create_clock -name {Clock_DMA_MEM_UART(routed)} -period 2000000 -waveform {0 1000000} [list [get_pins {ClockBlock/dclk_4}]]
...
create_generated_clock -name {Clock_DMA_FFT_UART} -source [get_pins {ClockBlock/clk_sync}] -edges {1 24001 48001} [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {Clock_DMA_MEM_UART} -source [get_pins {ClockBlock/clk_sync}] -edges {1 48001 96001} [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Project: C:\Users\zakis\Documents\SDHD_LAB\MovementDetector\40_Implementation\20_SW\10_work\MovementDetector\RADAR_Movement_Detector.cydsn\RADAR_Movement_Detector.cyprj
# Date: Mon, 08 Jul 2024 16:08:24 GMT
