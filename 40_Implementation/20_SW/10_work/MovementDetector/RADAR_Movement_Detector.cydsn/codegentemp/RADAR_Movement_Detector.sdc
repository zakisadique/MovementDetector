...
# Date: Sat, 22 Jun 2024 13:56:36 GMT
#set_units -time ns
...
create_clock -name {Clock_DMA_MEM_UART(routed)} -period 20000000 -waveform {0 10000000} [list [get_pins {ClockBlock/dclk_3}]]
create_clock -name {Clock_DMA_FFT_UART(routed)} -period 20000000 -waveform {0 10000000} [list [get_pins {ClockBlock/dclk_4}]]
...
create_generated_clock -name {Clock_DMA_MEM_UART} -source [get_pins {ClockBlock/clk_sync}] -edges {1 480001 960001} [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {Clock_DMA_FFT_UART} -source [get_pins {ClockBlock/clk_sync}] -edges {1 480001 960001} [list [get_pins {ClockBlock/dclk_glb_4}]]
