...
# Date: Sat, 22 Jun 2024 14:41:01 GMT
#set_units -time ns
...
create_clock -name {Clock_DMA_MEM_UART(routed)} -period 500000 -waveform {0 250000} [list [get_pins {ClockBlock/dclk_3}]]
create_clock -name {Clock_DMA_FFT_UART(routed)} -period 500000 -waveform {0 250000} [list [get_pins {ClockBlock/dclk_4}]]
...
create_generated_clock -name {Clock_DMA_MEM_UART} -source [get_pins {ClockBlock/clk_sync}] -edges {1 12001 24001} [list [get_pins {ClockBlock/dclk_glb_3}]]
create_generated_clock -name {Clock_DMA_FFT_UART} -source [get_pins {ClockBlock/clk_sync}] -edges {1 12001 24001} [list [get_pins {ClockBlock/dclk_glb_4}]]
...
# Project: C:\Users\zakis\Documents\SDHD_LAB\MovementDetector\40_Implementation\20_SW\10_work\MovementDetector\RADAR_Movement_Detector.cydsn\RADAR_Movement_Detector.cyprj
# Date: Sat, 22 Jun 2024 14:40:57 GMT
