...
/* `#END`  */
    ...
    *****************************************************************************/
    ...
    {
        #ifdef ADC_DelSig_ISR1_ENTRY_CALLBACK
            ADC_DelSig_ISR1_EntryCallback();
        #endif /* ADC_DelSig_ISR1_ENTRY_CALLBACK */
        ...
        */
			...
			*/
            ADC_DelSig_convDone = ADC_DelSig_DEC_CONV_DONE;
        #endif /* Single sample conversion mode with resolution above 16 bits */

        #ifdef ADC_DelSig_ISR1_EXIT_CALLBACK
            ADC_DelSig_ISR1_ExitCallback();
        #endif /* ADC_DelSig_ISR1_EXIT_CALLBACK */
    }
    ...
    *****************************************************************************/
    ...
    {
        #ifdef ADC_DelSig_ISR2_ENTRY_CALLBACK
            ADC_DelSig_ISR2_EntryCallback();
        #endif /* ADC_DelSig_ISR2_ENTRY_CALLBACK */
        ...
        */
        ...
        #ifdef ADC_DelSig_ISR2_EXIT_CALLBACK
            ADC_DelSig_ISR2_ExitCallback();
        #endif /* ADC_DelSig_ISR2_EXIT_CALLBACK */
    }
    ...
    *****************************************************************************/
    ...
    {
        #ifdef ADC_DelSig_ISR3_ENTRY_CALLBACK
            ADC_DelSig_ISR3_EntryCallback();
        #endif /* ADC_DelSig_ISR3_ENTRY_CALLBACK */        
        ...
        */
        ...
        #ifdef ADC_DelSig_ISR3_EXIT_CALLBACK
            ADC_DelSig_ISR3_ExitCallback();
        #endif /* ADC_DelSig_ISR3_EXIT_CALLBACK */        
    }
    ...
    *****************************************************************************/
    ...
    {
        #ifdef ADC_DelSig_ISR4_ENTRY_CALLBACK
            ADC_DelSig_ISR4_EntryCallback();
        #endif /* ADC_DelSig_ISR4_ENTRY_CALLBACK */            
        ...
        */
        ...
        #ifdef ADC_DelSig_ISR4_EXIT_CALLBACK
            ADC_DelSig_ISR4_ExitCallback();
        #endif /* ADC_DelSig_ISR4_EXIT_CALLBACK */            
    }
