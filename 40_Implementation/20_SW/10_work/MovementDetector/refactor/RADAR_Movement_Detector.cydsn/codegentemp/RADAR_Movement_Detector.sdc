...
# Date: Tue, 09 Jul 2024 12:50:30 GMT
#set_units -time ns
...
create_clock -name {Clock_DMA_FFT_UART(routed)} -period 1000000 -waveform {0 500000} [list [get_pins {ClockBlock/dclk_2}]]
...
create_generated_clock -name {Clock_DMA_FFT_UART} -source [get_pins {ClockBlock/clk_sync}] -edges {1 24001 48001} [list [get_pins {ClockBlock/dclk_glb_2}]]
